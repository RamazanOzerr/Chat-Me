...
//    FriendsAdapterOld friendsAdapter;
...
//        view = inflater.inflate(R.layout.fragment_friends_old, container, false);
...
//                friendsAdapter = new FriendsAdapterOld(friendList,getActivity(),getContext());
